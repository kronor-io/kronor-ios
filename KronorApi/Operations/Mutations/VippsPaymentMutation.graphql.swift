...
public extension KronorApi {
  nonisolated struct VippsPaymentMutation: GraphQLMutation {
    public static let operationName: String = "VippsPayment"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation VippsPayment($payment: VippsPaymentInput!, $deviceInfo: AddSessionDeviceInformationInput!) { newVippsPayment(pay: $payment) { __typename waitToken } addSessionDeviceInformation(info: $deviceInfo) { __typename result } }"#
      ))
    ...
    nonisolated public struct Data: KronorApi.SelectionSet {
      ...
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        VippsPaymentMutation.Data.self
      ] }
      ...
      nonisolated public struct NewVippsPayment: KronorApi.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }

        @_spi(Execution) public static var __parentType: any ApolloAPI.ParentType { KronorApi.Objects.VippsPaymentResult }
        @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("waitToken", String.self),
        ] }
        @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          VippsPaymentMutation.Data.NewVippsPayment.self
        ] }
      ...
      nonisolated public struct AddSessionDeviceInformation: KronorApi.SelectionSet {
        ...
        @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          VippsPaymentMutation.Data.AddSessionDeviceInformation.self
        ] }
