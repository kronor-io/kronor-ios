...
public extension KronorApi {
  class CreditCardPaymentMutation: GraphQLMutation {
    ...
    public static let document: ApolloAPI.DocumentType = .notPersisted(
      definition: .init(
        #"""
        mutation CreditCardPayment($payment: CreditCardPaymentInput!, $deviceInfo: AddSessionDeviceInformationInput!) {
          newCreditCardPayment(pay: $payment) {
            __typename
            waitToken
          }
    ...
    public struct Data: KronorApi.SelectionSet {
      ...
      public struct NewCreditCardPayment: KronorApi.SelectionSet {
        ...
        public static var __parentType: ApolloAPI.ParentType { KronorApi.Objects.CreditCardPaymentResult }
        public static var __selections: [ApolloAPI.Selection] { [
